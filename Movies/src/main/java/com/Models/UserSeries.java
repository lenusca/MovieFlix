...
public class UserSeries {
	...
	public List<Serie> userseries = new ArrayList<>();
	...
	public List<Serie> getUserseries() {
		return userseries;
	}

	public void setUserseries(List<Serie> userseries) {
	...
	public String toString() {
		return "UserSeries [runtime=" + runtime + ", userseries=" + userseries + ", Comedy=" + Comedy + ", Animation="
				+ Animation + ", Romance=" + Romance + ", Drama=" + Drama + ", Horror=" + Horror + ", Adventure="
				+ Adventure + ", Crime=" + Crime + ", Action=" + Action + ", imdbRating2=" + imdbRating2
				+ ", imdbRating4=" + imdbRating4 + ", imdbRating6=" + imdbRating6 + ", imdbRating8=" + imdbRating8
				+ ", imdbRating10=" + imdbRating10 + "]";
	}
